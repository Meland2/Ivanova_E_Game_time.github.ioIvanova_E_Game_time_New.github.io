...
alert("Правила: Нажимай на лампу в течение одной минуты или быстрее! У тебя есть только одна секунда на нажатие. Нажимай все для достижения наилучшего результата! Игра перейдет на следующий уровень автоматически")
